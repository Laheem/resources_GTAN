...
using GTANetworkShared;
    ...
    {
        API.playPlayerAnimation(player, (int)(AnimationFlags.Loop | AnimationFlags.OnlyAnimateUpperBody), "mp_fbi_heist", "card_swipe");
    }

    [Command("wave")]
    public void startCheer(Client player)
    {
        API.playPlayerAnimation(player, (int)(AnimationFlags.Loop | AnimationFlags.OnlyAnimateUpperBody), "random@car_thief@waving_ig_1", "waving");
    ...
    {
        API.playPlayerAnimation(player, (int)(AnimationFlags.Loop), "amb@world_human_bum_slumped@male@laying_on_left_side@idle_a", "idle_a");
